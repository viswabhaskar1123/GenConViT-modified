...
#         # Upgraded models to ConvNeXt V2 and ViT
#         if self.net == 'ed':
#             self.model_ed = GenConViTED(config)
#             self.load_weights(self.model_ed, f'weight/{ed}.pth')
#         elif self.net == 'vae':
#             self.model_vae = GenConViTVAE(config)
#             self.load_weights(self.model_vae, f'weight/{vae}.pth')
#         else:
#             self.model_ed = GenConViTED(config)
#             self.model_vae = GenConViTVAE(config)
#             self.load_weights(self.model_ed, f'weight/{ed}.pth')
...
#                 model.half()
#         except FileNotFoundError:
#             raise Exception(f"Error: {path} file not found.")
